...
public class ExcelUtils {
    ...
    public static String getCellString(jxl.Sheet sheet, Integer column, Integer row) {
    ...
    public static Integer getCellInteger(jxl.Sheet sheet, Integer column, Integer row) {
        String value = sheet.getCell(column, row).getContents().trim();
        if (value == null || "".equals(value)) {
            return null;
        } else {
            return Integer.valueOf(sheet.getCell(column, row).getContents().trim());
        }
    }

    public static Double getCellDouble(jxl.Sheet sheet, Integer column, Integer row) {
