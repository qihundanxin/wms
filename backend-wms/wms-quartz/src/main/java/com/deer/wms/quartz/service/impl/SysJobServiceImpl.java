...
import com.deer.wms.quartz.constant.ScheduleConstants;
...
@Service
@Slf4j
public class SysJobServiceImpl extends AbstractService<SysJob, Integer> implements ISysJobService {
     ...
     * 批量删除调度信息
     *
     * @param sysJobData 需要删除的数据ID
     * @return 结果
     */
    @Override
    @Transactional
    public void deleteJobByIds(SysJobData sysJobData) throws SchedulerException {
//        Long[] jobIds = Convert.toLongArray(sysJobData);
        for (Long jobId : sysJobData.getIds()) {
