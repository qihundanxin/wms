<template>
  <div class="resInware">
    ...
    <div class="formBox">
      ...
      <div class="formRow">
        <span class="lable required">入库性质</span>
        <input class="noBdIpt" type="text" placeholder="请选择入库性质" />
      </div>
      <div class="formRow">
        <span class="lable required">计划到货</span>
...
export default {
  ...
  methods: {
    toAddItem() {
      this.$router.push({ name: "addItem", params: {fromRoute:"resInware"} });
      this.$route.params
    },
    hideTable(index) {
