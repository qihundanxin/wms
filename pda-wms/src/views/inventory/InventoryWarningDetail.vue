<template>
  <div class="inventoryWarningDetail">
    ...
    <div class="bills">
      <div class="bill" v-for="billData,index in billDatas">
        <!--<p>
        ...
        <div class="sq" style="overflow: hidden;background: #F2F6FC;">
          <p>
            <span>数量</span>
