<template>
    <div class="releaseCell">
        ...
        <div style="text-align: center;">
            ...
            <el-button @click="commitForm('form')" type="primary" size="mini" round icon="iconfont icon-user-jinyong
"
                       style="width: 100px;margin-top: 5px;right: auto"> 锁定
            </el-button>
        </div>
