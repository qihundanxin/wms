        ...
        <li v-for="(item, index) in stockTakeTasks" :key="index">
          <el-card class="clearFloat">
            <div class="cardBody">
              ...
              <div style="font-size:10px" class="baseData clearFloat">
                <!-- 基础信息 -->
                <ul style="font-size:10px" class="leftFloat">
                  <!-- <li>
                    <span>单号:</span>
              ...
              <div style="font-size:10px" v-if="item.type == 1" class="mainData clearFloat">
                <!-- 重要信息 -->
                <ul style="font-size:10px" class="leftFloat">
                  <li>
                ...
                <ul style="font-size:10px" class="rightFloat">
                  <li>
            ...
            <div v-if="stockTake != null && stockTake.stockTakeTaskId == item.stockTakeTaskId"
              ...
              <div class="rightFloat" v-bind:id="'commit' + index" @click="commit(item, index)">
                确认
              </div>
            </div>
          </el-card>
        ...
        (ret) => {
          ...
          if (ret.code === 200) {
            if (this.stockTakeTasks.length == 0 && ret.total == 0) {
              IOT.tips("没找到盘点单" + (this.searchData.masterBillNo == null ? '' : this.searchData.masterBillNo) + "，或初盘任务已完成", "error");
              return;
            }
