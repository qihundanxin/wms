        ...
        <div style="text-align: center;">
            <el-form class="noMargin BoxingPickTaskBox" :model="form" ref="form">
                ...
                <el-form-item label="波次号" :label-width="formLabelWidth">
                    <el-input v-model="searchData.waveCode" size="mini" style="width: 60%;">
                    </el-input>
                ...
                <el-form-item label="箱号" :label-width="formLabelWidth">
                    <el-input v-model="form.boxNo" size="mini" style="width: 60%;" @change="getBoxDetailData">
                    </el-input>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            getPickTaskData() {
                let that = this
                if(!PF.isNull(that.searchData.waveCode)){
                    IOT.tips('请输入波次号！', 'error');
                    return false;
                }
                this.loading = true;
            ...
            getInventoryData() {
                IOT.getServerData('/inventorys/checkList', 'get', {itemCode: this.form.itemCode, waveCode: this.searchData.waveCode}, (ret) => {
                    if (ret.code === 200) {
