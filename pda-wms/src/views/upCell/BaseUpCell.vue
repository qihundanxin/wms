<template>
  <div class="baseUpCell">
    ...
    <div style="text-align: center;">
      ...
      <el-button @click="searchData.pageSize = 2;inventoryBalances = [];getInventoryBalanceData()" type="primary" size="mini" round icon="iconfont icon-chaxun" style="width: 200px;margin-top: 5px;"> 查询</el-button>
    </div>
    ...
    <div class="baseAcceptBillBox noScrollbar">
      <ul v-infinite-scroll="lazy">
        <li v-for="(item,index) in inventoryBalances" @click="$router.push({name: 'baseUpCell2',params: item})">
          <el-card>
