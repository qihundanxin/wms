      ...
      <div class="cellModalBox">
        <el-form class="clearFloat" :model="formAccept" :rules="rulesAccept" ref="formAccept">
          ...
          <el-form-item label="预约数 " prop="expectQuantity+'/'+acceptQuantity" :label-width="formLabelWidth">
            <span>{{formAccept.expectQuantity}}（主单位）</span>
          </el-form-item>
          ...
          <el-tab-pane :label="isFile?'入库单归档单据信息':'入库单据信息'" name="first">
            <div class="newBillData clearFloat">
              ...
              <ul class="leftFloat">
                ...
                <li>
                  <span>创建时间:</span>
                  <span :title="asnMaster.createTimeStr">&nbsp;{{asnMaster.createTimeStr}}</span>
                </li>
                <li>
                  <span>预期到货时间:</span>
        ...
        <div class="tableBox">
          ...
          <template slot-scope="scope">
            <el-row :gutter="20">
              ...
              <el-col :span="16">
                <div @click="$parent.showPublicModal(scope.row.itemCode, 'item')" style="display: inline-block;margin-left:5px; height:86px">
        ...
        IOT.getServerData(url, 'get', {billNo: this.searchData.billNo}, (ret) => {
          if (ret.code === 200) {
            ...
            if (PF.isNull(list.createTime)) {
              list.createTimeStr = DateUtils.timeToStr(list.createTime, 'MM-dd hh:mm');
            }
