...
<el-option :key="4" label="调拨" :value="4">调拨</el-option> -->
    ...
    <div class="headerBtns">
      <el-button
          ...
          @click="$router.push({ name: 'createAsnReturnBill' })"
      >
        新增
      </el-button
      >
  ...
  width="180">
  <template slot-scope="scope">
    <span class="textBtn" @click="$router.push({name: 'AsnReturnBillDetail',params: scope.row})">{{scope.row.billNo}}</span>
  </template>
</el-table-column>
  <el-table-column
  show-overflow-tooltip
