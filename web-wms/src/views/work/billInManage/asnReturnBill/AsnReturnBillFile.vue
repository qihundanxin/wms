      ...
      <div class="searchBar" :style="{height: isMoreSearch?'auto':''}">
        ...
        <div>
          ...
          <el-select v-model="searchData.billSource" size="mini" filterable placeholder="请选择单据来源" clearable>
            <el-option :key="0" label="采购单" :value="0"></el-option>
...
<script>
  ...
  export default{
    ...
    methods: {
      ...
      getBuyBillInData(){
        IOT.getServerData('/asn/master/files/list','get',this.searchData,(ret) => {
          if (ret.code === 200) {
