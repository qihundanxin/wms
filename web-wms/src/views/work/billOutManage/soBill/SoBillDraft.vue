<template>
  <div class="soBillDraft">

    <div class="publicSearch">
      <div class="searchBar" :style="{height: isMoreSearch?'auto':''}">
        <el-button-group>
          <el-button @click="getSoBillData" size="mini" icon="el-icon-search">查询</el-button>
    ...
    <div class="tableBox">
      <el-table
        ...
        <el-table-column
          ...
          width="180">
          <template slot-scope="scope">
            <span v-if="scope.row.state === 1">部分收货</span>
            <span v-else-if="scope.row.state === 0">全部收货</span>
          </template>
        </el-table-column>
        <el-table-column
          sortable
