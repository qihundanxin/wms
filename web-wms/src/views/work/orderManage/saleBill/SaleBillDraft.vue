<template>
  <div class="saleBillDraft">

    <div class="publicSearch">
      <div class="searchBar" :style="{height: isMoreSearch?'auto':''}">
        <el-button-group>
          <el-button @click="getSaleData" size="mini" icon="el-icon-search">查询</el-button>
    ...
    <div class="tableBox">
      <el-table
        ...
        <el-table-column
          ...
          width="120">
          <template slot-scope="scope">
            <span v-for="(item,index) in saleTypes" :key="index" v-if="scope.row.saleType === item.dataDictDetailId">{{item.dictValue}}</span>
          </template>
        </el-table-column>
        <el-table-column
          sortable
